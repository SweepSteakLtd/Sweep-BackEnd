...
test('createUserHandler - returns 422 if deposit_limit.daily is missing', async () => {
  mockSelectExecute([]);
...
test('createUserHandler - returns 422 if deposit_limit values are negative', async () => {
  mockSelectExecute([]);
...
test('createUserHandler - returns 422 if deposit_limit daily exceeds weekly', async () => {
  mockSelectExecute([]);
...
test('createUserHandler - returns 422 if deposit_limit weekly exceeds monthly', async () => {
  mockSelectExecute([]);
