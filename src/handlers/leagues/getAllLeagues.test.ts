...
test('getAllLeaguesHandler - returns all leagues when no filters', async () => {
  ...
  const leagues = [
    { id: 'l1', name: 'League 1', description: 'Test league 1', entry_fee: 100 },
    { id: 'l2', name: 'League 2', description: 'Test league 2', entry_fee: 200 },
  ];
...
test('getAllLeaguesHandler - returns filtered leagues by search term', async () => {
  ...
  const leagues = [
    { id: 'l1', name: 'Awesome League', description: 'Test league 1', entry_fee: 100 },
    { id: 'l2', name: 'League 2', description: 'An awesome league', entry_fee: 200 },
    { id: 'l3', name: 'League 3', description: 'Test league 3', entry_fee: 300 },
  ];
  mockSelectExecute(leagues);
